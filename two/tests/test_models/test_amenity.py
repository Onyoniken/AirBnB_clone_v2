...
class test_inherit_basemodel(unittest.TestCase):
    """whether user inherit from BaseModel"""
...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_save_method(self, mock_storage):
        """Testing save method and update"""
        instance5 = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Test Amenity has attribute name, and is empty"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """creates a dictionary with proper attrs"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """test values in dict from to_dict are correct"""
