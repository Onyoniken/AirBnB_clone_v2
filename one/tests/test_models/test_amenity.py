...
class test_inherit_basemodel(unittest.TestCase):
    """Test whether user inherited from BaseModel"""
    def test_instance(self):
        """check whether user is an instance of BaseModel"""
        user = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """Tests whether amenity is a subclass of BaseModel"""
        amenity = Amenity()
    ...
    def test_name_attr(self):
        """Test whether Amenity has attribute name, and empty"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """test to_dict method creates a dict with attributes"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """test that values returned from dict are correct"""
    ...
    def test_str(self):
        """validates wheter str method returns correct output"""
        amenity = Amenity()
